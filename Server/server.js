...
module.exports = {
  ...
  Stop: function () {
    ...
    this.server_https.close()
  },
  Start: function (configs) {
    const db = require('./MySQLDBManager')(configs).connectAll()
    this.db = db
    ...
    const Documents = ['SSS', 'SRS', 'SDD', 'STD', 'STR']
    ...
    this.server_https = https.createServer(ssl, app).listen(444, function () { console.log('Https server listening on port ' + 444) })
    ...
    this.server_http = app.listen(80, function () { console.log('Service Start!') })
